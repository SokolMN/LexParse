...
public class Exec {
    ...
    //Арифметические операции. В каждом из них идет сначала поиск перменных, если на вход подается переменная типа VAR. Если переменная не типа VAR, то идет простая рафиметическая операция с соседними числами
